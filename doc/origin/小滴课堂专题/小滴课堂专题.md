...
- 同步方法字节码
  ...
  ![image-20200210184107485](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/同步方法字节码.png)

- 同步代码块字节码

![image-20200210183949717](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/同步代码块字节码.png)
...
![image-20200210183813283](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/synchronized-img.png)
...
![image-20200212185212328](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200212185212328.png)
...
![image-20200212185349818](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200212185349818.png)
...
- 知道AQS吗？能否介绍下，它的核心思想是什么
  ...
  ![image-20200214151433962](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200214151433962.png)
...
![image-20200214165922487](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200214165922487.png)

- 公平锁和非公平锁核心区别

![image-20200214170916300](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200214170916300.png)
...
- 知道ReentrantReadWriteLock吗？和ReentrantLock有啥不同？
  ...
  ![image-20200215105626961](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200215105626961.png)
...
- 【阿里巴巴编码规范】 线程池不允许使用 Executors 去创建，要通过 ThreadPoolExecutor的方式原因？
  ...
  直接使用ThreadPoolExecutor让使用者更加清楚线程池允许规则，常参数的使用，避免风险
  常见的线程池问题：
...
![image-20200221104045559](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200221104045559.png)

![image-20200221104151858](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200221104151858.png)
...
![image-20200225121843174](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200225121843174.png)
...
![image-20200225121812567](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200225121812567.png)
...
![image-20200225121742209](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200225121742209.png)
...
- 你用了消息队列，你知道这个消息队列如何保证消息的可靠性传输吗
  ...
  broker端：
  	 ...
  	 【rocketmq设置#刷盘方式，ASYNC_FLUSH 异步刷盘，SYNC_FLUSH 同步刷盘  flushDiskType=ASYNC_FLUSH】
  	 故障：
...
![image-20200225121709073](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200225121709073.png)
...
![image-20200225121517029](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200225121517029.png)

 

![image-20200225121605489](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200225121605489.png)

 

![image-20200225121630567](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200225121630567.png)
...
例子：
  老王在小滴课堂有1000积分，准备去兑换《专题课程》，查询数据库确实有1000积分
  但是老王的女友同时也在别的地方登录，把1000积分兑换了《SpringCloud微服务专题课程》，且在老王之前提交事务；当系统帮老王兑换《专题课程》是发现积分预计没了，兑换失败。
...
Repeatable Read(可重复读,mysql默认的事务隔离级别)
  ...
  例子
  老王在小滴课堂有1000积分，准备去兑换《专题课程》，查询数据库确实有1000积分
  老王的女友同时也在别的地方登录先兑换了这个《专题课程》，老王的事务提交的时候发现存在了，之前读取的没用了，像是幻觉
...
![image-20200229195411491](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200229195411491.png)



### 第十二章 生产环境数据库性能监控和优化环节
...
![image-20200229195643201](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200229195643201.png)
...
![image-20200229195817665](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200229195817665.png)
...
![image-20200606173941994](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200606173941994.png)
...
### 第十四章 Spring-Mybatis框架系列常见题

 

#### 第1集 Spring框架核心知识点你是否掌握
...
- Spring里面 bean的scope作用域有哪些，能否解释下
...
![image-20200416191234834](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200416191234834.png)



#### 第3集 Spring AOP 代理模式题

**简介：Spring常见题静态代理和动态代理**
...
#### 第4集  CGLib动态代理和JDK动态代理的常见题

**简介：CGlib动态代理和JDK动态代理的常见题**
...
#### 第5集  JDBC和Mybaits基础题你知道多少

**简介：讲解JDBC和Mybatis基础题**

- 考点：JDBC和Mybatis基础题考查
- 难度：【** *】
...
![image-20200411134415859](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200411134415859.png)

 

#### 第6集 Mybatis3.X 防止注入知识点

**简介：mybatis3.x 防止sql注入知识点**
...
![image-20200607094724502](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200607094724502.png)
...
### 第十六章 带你看小滴课堂微服务架构+编写BAT高级工程师简历
...
![image-20200303233428197](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200303233428197.png)
...
#### 第3集 编写大厂月薪20k+的高级工程师简历【原创】

**简介：讲师小D原创，解读一份大厂高级工程师的简历**
...
![image-20200303195610120](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200303195610120.png)
...
![image-20200303195720672](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200303195720672.png)

 

![image-20200303233529453](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200303233529453.png)
...
![image-20200303195742539](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200303195742539.png)

![image-20200303233459841](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200303233459841.png)
...
![image-20200303195759000](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200303195759000.png)
...
![image-20200303200124649](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/image-20200303200124649.png)
...
### 第十七章 小滴课堂第一季专题总结章和后续规划



#### 第1集 小滴课堂专题第一季课程总结

**简介：小滴课堂专题课程总结和学习路线建议**
...
![u=4073844855,1130410908&fm=26&gp=0](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/u=4073844855,1130410908&fm=26&gp=0.png)

 

![WechatIMG1](file:///D:/JetBrains/IntelliJ_directory/Learning/doc/origin/小滴课堂专题/课程完整笔记_files/WechatIMG1.png)
